...
hi ColorColumn guibg=red ctermbg=red
hi clear Conceal
...
set softtabstop=4   " backspace behavior deletes (tabstop) spaces
...
" some text width settings
let txt=80
let &tw=txt
let &colorcolumn=(txt+1)
